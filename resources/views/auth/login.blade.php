...
@section('content')
    ...
    <script>
        // Check if the success message exists in the session and display it using toastr
        @if (session('success'))
            toastr.success('{{ session('success') }}');
        @endif

        // Check if the error message exists in the session and display it using toastr
        @if (session('error'))
