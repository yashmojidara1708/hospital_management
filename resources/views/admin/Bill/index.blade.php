                ...
                <div class="col-md-6">
                    <div class="invoice-info">
                        ...
                        <div class="float-left">
                            ...
                            <p class="mb-1"><i class="fa fa-map-marker"></i> {{ $patientdetail->patient_address ?? 'N/A' }}, <br>
                                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$patientdetail->city_name ?? 'N/A'}}, {{$patientdetail->state_name ?? 'N/A'}}</p>
                            <p class="mb-1"><i class="fa fa-phone"></i>  {{ $patientdetail->patient_phone ?? 'N/A' }}</p>
                ...
                <div class="col-md-6">
                    <div class="invoice-info invoice-info2">
                        ...
                        <div class="float-right">
                            ...
                            <p class="mb-1"><i class="fa fa-user-md"></i>  Dr. {{ $patientdetail->doctor_name ?? 'N/A' }}</p>
                            <p class="mb-1"><i class="fa fa-user-graduate"></i>  {{ $patientdetail->specialization_name ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
            </div>
...
<table class="table table-bordered">
    ...
    <tbody>
        <tr class="text-center">
            ...
            <td>{{ $patientdetail->discharge_date ? date('d-M-Y', strtotime($patientdetail->discharge_date)) : 'N/A' }}</td>
        </tr>
    </tbody>
</table>
