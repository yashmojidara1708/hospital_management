...
class PatientController extends Controller
{
    ...
    public function patientslist()
    {
        ...
        $patients = DB::table('patients')
                    ...
                    ->select('patients.patient_id', 'patients.name', 'patients.email', 'patients.phone',
                    'patients.age','patients.last_visit', 
    ...
    public function fetchAppointments($id)
    {
        $appointments=DB::table('appointments')
                    ...
                    ->select('appointments.date','patients.last_visit', 
                            'doctors.name','doctors.image','appointments.status')
                    ->get();
